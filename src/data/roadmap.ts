...
export const ROADMAP_MODULES: RoadmapModule[] = [
  { key: 'floorplan-recognition', title: '户型识别', description: '上传底图、墙体补全、门窗候选、房间候选、质量报告和图层精修。', status: 'beta', benchmark: 'Planner 5D / Homestyler', version: 'V3-V9' },
  ...
  { key: 'format-io', title: '格式导入导出', description: '支持 PNG、SVG、JSON、HTML、CSV、打印布局、PDF 打印页和 DXF/GLB/OBJ 草案。', status: 'beta', benchmark: 'Sweet Home 3D / Magicplan', version: 'V5-V10' }
];
